...
public class DialogoCliente {
	...
	void onAddButtonAction(ActionEvent event) {
		...
		dialog.setHeaderText("Inserta un nuevo cliente");

		// PONER ICONO DEL PADRE
		Stage stage = (Stage) dialog.getDialogPane().getScene().getWindow();
		//stage.getIcons().setAll(ClienteApp.getPrimaryStage().getIcons());
		...
		Label customer = new Label("Id cliente: ");
		...
		customerCombo.setPromptText("Cliente");

		TextField nameText = new TextField();
		nameText.setPromptText("Nombre Cliente:");
		...
		HBox customerBox = new HBox(customer, customerCombo, name, nameText);
	...
	void onDeleteButtonAction(ActionEvent event) {
		...
		alert.setHeaderText("");
		alert.setContentText("Esta usted seguro de eliminar este cliente: ");
